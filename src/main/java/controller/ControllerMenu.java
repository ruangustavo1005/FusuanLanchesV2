...
public class ControllerMenu extends Controller {
    ...
    /**
     * Adiciona a ação do botão de editar configuraÃ§çs
     */
    ...
    /**
     * Adiciona a ação do botão de cadastrar solicitaÃ§çs de abastecimento
     */
    ...
    /**
     * Adiciona a ação do botão de consultar solicitaÃ§çs de abastecimento
     */
